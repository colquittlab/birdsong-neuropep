...
source("~/nest/rstudio/spatial_expression/spatial_expression.R")
...
script_name = "deaf_bus_trimmed_merge_3p_seurat_lman-filter_atlas-expression_npp"
...
# Expression
```{r}
#to_plot = intersect(rownames(obj), c(nps, nprs))
to_plot = intersect(rownames(obj), nps$SYMBOL)
